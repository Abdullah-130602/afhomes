      ...
      >
        <div className="max-w-2xl">
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Discover premium real estate properties in your desired location. Your perfect home awaits.
          </motion.p>
          ...
          >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05, boxShadow: '0 20px 25px rgba(255, 255, 255, 0.2)' }}
              whileTap={{ scale: 0.95 }}
              transition={{ type: 'spring', stiffness: 400, damping: 10 }}
            >
              Contact Agent
